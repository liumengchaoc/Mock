...
public class MyApp extends Application {
    private static  String mock=Environment.getExternalStorageDirectory()+"mock";
    ...
    public static void  peizhi(){
        File file = new File(mock);  //缓存文件夹路径
...
// default
                ...
                .memoryCacheSizePercentage(13) // default// default 可以自定义缓存路径
